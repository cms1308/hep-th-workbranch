...
These eleven sanitized cases cover failures recorded during research: finite-order
...
global bounds inferred from local maxima, optimization inputs missing constraints, and premature termination at a stationary nonmaximum.
