---
name: resume-project
description: Cold-start into an ongoing research project — read its state files, brief the user on what the project is and where it stands, then continue. Use at the start of a new session or when the user asks where a project stands. (Named resume-project because /resume is a Codex built-in.)
---
